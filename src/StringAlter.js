...
const RangeOffset = require('./RangeOffset.js');
const Record = require('./Record.js');

const assert = this["assert"] || ((expect, msg) => { if(expect != true)throw new Error(msg || "") });
const assign = /*Object['assign'] || */(t, s) => {for(var p in s){if(s.hasOwnProperty(p)){t[p]=s[p];}}return t};
